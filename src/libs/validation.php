...
const DEFAULT_VALIDATION_ERRORS = [
    ...
    'max_str_len' => 'The %s must have at most %s characters',
    'min_str_len' => 'The %s must have at least %s characters',
];
...
function validate(array $data, array $fields, array $messages = []): array
{
    ...
    $error_message = array_filter($messages, fn($message) => is_string($message));

    $validation_errors = array_merge(DEFAULT_VALIDATION_ERRORS, $error_message);
